...
public class Password {
    ...
    public static String hashPassword(String password_plaintext) {
        String salt = BCryptEncryptor.gensalt(workload);
        String hashed_password = BCryptEncryptor.hashpw(password_plaintext, salt);
    ...
    public static boolean checkPassword(String password_plaintext, String stored_hash) {
        ...
        password_verified = BCryptEncryptor.checkpw(password_plaintext, stored_hash);
